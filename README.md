...
- **Source scope:** the auditable canonical inventory identifies one `全体公開` post otherwise absent from November 2019; it was copied. Post `644361` is already represented by the human-owned origin/main article `content/posts/2019/11/2019-11-13.md` using FANBOX's former `www.fanbox.cc/@kinneko/posts/644361` URL form. The audit recognizes that URL as the same post ID, without rewriting published human content. No restricted or supporter-only content was copied.
